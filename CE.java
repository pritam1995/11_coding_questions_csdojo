...
public class CE {
    public static void main(String[] args) {
        ...
        Integer[] res = commonElements(array1B, array2B);
         for (int element: res) {
        ...
        //System.out.println(Arrays.toString(common_elements(array1C, array2C)));
        System.out.println(Arrays.toString(commonElements(array1C, array2C)));
        Integer[] res1 = commonElements(array1C, array2C);
        if(res1.length==0)
